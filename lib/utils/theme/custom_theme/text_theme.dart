...
class KTextTheme {
  ...
  static TextTheme lightTextTheme = TextTheme(
    ...
    labelSmall: const TextStyle().copyWith(fontSize: 14.0, fontWeight: FontWeight.normal, color: Colors.black.withOpacity(0.5)),
  );
  static TextTheme darkTextTheme = TextTheme(
    ...
    labelSmall: const TextStyle().copyWith(fontSize: 14.0, fontWeight: FontWeight.normal, color: Colors.white.withOpacity(0.5)),
  );
}